...
export class CampaignPanel {
  ...
  constructor(private readonly scene: Phaser.Scene, session: CampaignSessionView, state: PanelState, actions: PanelActions) {
    ...
    this.label(28, 60, 'Локальная пошаговая партия · S3.9 · 6 систем', 14, '#859bb6');
    ...
    this.label(28, 680, 'Прототип: размещение в своей колонии. Перелёт есть в модели, кнопок и боя пока нет. Партия не сохраняется.', 15, '#99adc5');
  }
